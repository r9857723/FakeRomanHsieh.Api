...
namespace FakeRomanHsieh.API.Migrations
{
    ...
    [Migration("20210727130824_OrdersMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FakeRomanHsieh.API.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "XXXD4F10-79ED-4AFF-A915-4CE29DC9C7E9",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d6b85bc2-090f-46d5-8648-88ec32b4755b",
                            Email = "admin@FakeRomanHsieh.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@FAKEROMANHSIEH.COM",
                            NormalizedUserName = "ADMIN@FAKEROMANHSIEH.COM",
                            PasswordHash = "AQAAAAEAACcQAAAAEMpPiDLjOTgmTfex3WRuat7af45xxHzI9uJfDFNU5rzapjR3ceeWZOLuAKxU/V/f5A==",
                            PhoneNumber = "0912456789",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "f5b6285d-7936-420b-9512-c816a61fba60",
                            TwoFactorEnabled = false,
                            UserName = "admin@FakeRomanHsieh.com"
                        });
                });

            modelBuilder.Entity("FakeRomanHsieh.API.Models.LineItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("FakeRomanHsieh.API.Models.Order", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("TranscationMetadata")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("FakeRomanHsieh.API.Models.ShoppingCart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("FakeRomanHsieh.API.Models.TouristRoute", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("3ecbcd92-a9e0-45f7-9b29-e03272cb0862"),
                            CreateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DepartureCity = 1,
                        ...
                        new
                        {
                            Id = new Guid("39996f34-013c-4fc6-b1b3-0c1036c47113"),
                            CreateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            DepartureCity = 3,
            ...
            modelBuilder.Entity("FakeRomanHsieh.API.Models.TouristRoutePicture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "07fa7658-b7ea-4d14-8d13-0faca5c43898",
                            Name = "Admin",
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<string>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "XXXD4F10-79ED-4AFF-A915-4CE29DC9C7E9",
            ...
            modelBuilder.Entity("FakeRomanHsieh.API.Models.LineItem", b =>
                {
                    b.HasOne("FakeRomanHsieh.API.Models.Order", null)
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId");

                    b.HasOne("FakeRomanHsieh.API.Models.ShoppingCart", null)
                        .WithMany("ShoppingCartItems")
                        .HasForeignKey("ShoppingCartId");

                    b.HasOne("FakeRomanHsieh.API.Models.TouristRoute", "TouristRoute")
                        .WithMany()
            ...
            modelBuilder.Entity("FakeRomanHsieh.API.Models.Order", b =>
                {
                    b.HasOne("FakeRomanHsieh.API.Models.ApplicationUser", "User")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("FakeRomanHsieh.API.Models.ShoppingCart", b =>
                {
                    b.HasOne("FakeRomanHsieh.API.Models.ApplicationUser", "User")
                        ...
                        .HasForeignKey("FakeRomanHsieh.API.Models.ShoppingCart", "UserId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("FakeRomanHsieh.API.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
